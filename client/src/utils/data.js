export const userInfo = [
  ...
  {books: [10, 20], status: 'Читатель', img: '/statuses/newbie-reader.svg'},
  {books: [20, 30], status: 'Библиофил', img: '/statuses/bibliophile.svg'},
  {books: [30, 40], status: 'Книголюб', img: '/statuses/bibliophile.svg'},
  {books: [40, 50], status: 'Литературный гурман', img: '/statuses/book gourmet.svg'},
  {books: [50, 75], status: 'Книжный фанат', img: '/statuses/book-fan.svg'},
  {
    books: [75, 100],
